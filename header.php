            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    if (!empty($header[0]['site_logo'])) { ?>
                        <a href="index.php" class="logo-img"><img src="images/<?php echo $header[0]['site_logo']; ?>" alt=""></a>
                    <?php } else { ?>
                ...
                <div class="col-md-7">
                    <form action="search.php" method="GET">
                        <div class="input-group search">
                            <input type="text" class="form-control" name="search" placeholder="Search for products here">
