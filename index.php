            ...
            <div class="col-md-12">
                ...
                <div class="popular-carousel owl-carousel owl-theme">
                    ...
                    if (isset($_COOKIE['user_wishlist']) && !empty($_COOKIE['user_wishlist'])) {
                        ...
                        $pids = implode(',', $pid);
                        $db = new Database();
                        $db->select('products', '*', null, "product_cat IN ({$pids})", null, null);
                        $result = $db->getResult();
                        if (count($result) > 0) {
                            foreach ($result as $row) { ?>
                                <div class="product-grid latest item">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="price"><?php echo $cur_format; ?> <?php echo $row['product_price']; ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    } elseif (isset($_COOKIE['user_cart'])) {
                        ...
                        <div>
                            Please continue browsing to get more recommendation.
                        </div>
                    <?php    }
                    ?>
                </div>
