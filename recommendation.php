<div class="product-section popular-products">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="section-head">Recomended for you</h2>
                <div class="popular-carousel owl-carousel owl-theme">
                    <?php
                        // $db->select('products','*',null,'product_cat = 9');
                        $conn = new mysqli('localhost', 'root', '', '');
                        $sql = "SELECT * FROM products INNER JOIN user on products.product_id = user.search";
