                ...
                <?php
                    if(isset($_COOKIE['user_cart'])){
                        ...
                        <?php    } ?>
                                ...
                                <form action="https://uat.esewa.com.np/epay/main" class="checkout-form pull-right" method="POST">
                                    <?php
                                        $product_id = '';
                                    ...
                                    <input value="http://localhost/project/success.php" type="hidden" name="su">
                                    <input value="http://localhost/project/payfailure.php" type="hidden" name="fu">
                                    <input type="hidden" name="amt" id="amt" class="total-price" value="<?php echo $product_price; ?>">
                                    <input type="hidden" name="tAmt" id="tAmt" class="total-price" value="<?php echo $product_price; ?>">
                                ...
                                <?php }else{ ?>
                                    <a class="btn btn-sm btn-success pull-right" href="#" data-toggle="modal" data-target="#userLogin_form" >Proceed to Checkout via esewa</a>
                                <?php } ?>
                <?php   }
                    }else{ ?>
